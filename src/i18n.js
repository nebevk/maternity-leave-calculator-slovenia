...
const messages = {
    en: {
        ...
        calculator: {
            ...
            tlPaternityEnd: "Paternity leave window ends",
            tlPaternityWindow: "{days} days, can be split until child is 3 months old",
    ...
    sl: {
        ...
        calculator: {
            ...
            tlPaternityEnd: "Konec obdobja za očetovski dopust",
            tlPaternityWindow: "{days} dni, lahko se razdeli do 3. meseca otroka",
